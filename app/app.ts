...
import { FsDirent, TypedIpcMain, TypedIpcSender } from '../common/ipc.js'
import { ReplayShieldBatteryData } from '../common/replays.js'
import { setAppId } from './app-id.js'
import { checkShieldBatteryFiles } from './check-shieldbattery-files.js'
import currentSession from './current-session.js'
import { registerCurrentProgram } from './file-association.js'
import { findInstallPath } from './find-install-path.js'
import { ActiveGameManager } from './game/active-game-manager.js'
import { checkStarcraftPath } from './game/check-starcraft-path.js'
import createGameServer, { GameServer } from './game/game-server.js'
import { MapStore } from './game/map-store.js'
import logger from './logger.js'
import { RallyPointManager } from './rally-point/rally-point-manager.js'
import { parseShieldbatteryReplayData } from './replays/parse-shieldbattery-replay.js'
import { collect } from './security/client.js'
import { LocalSettingsManager, ScrSettingsManager } from './settings.js'
import type { NewInstanceNotification } from './single-instance.js'
