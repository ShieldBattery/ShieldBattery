// This file is the first one that executes. It should avoid pulling in much until things have
// been configured and we're sure the app should even run (e.g. check if another instance is
// already running)
