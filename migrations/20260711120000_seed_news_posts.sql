-- One-time import of the formerly-hardcoded client news entries (previously
-- client/news/static-news-entries.tsx, now deleted) into the news_posts table. The fixed UUIDs
-- (5eed0000-...-0000000000NN, NN = 1-based array index) keep the old /static-news/:index links
-- redirectable and keep every environment consistent. author_id and cover_image_path are NULL, and
-- updated_at mirrors published_at (these historical rows have no synthetic edit history). Content is
-- stored already-dedented, exactly as the static detail page rendered it, so it needs no dedent at
-- render time.

INSERT INTO news_posts
    (id, author_id, cover_image_path, title, summary, content, published_at, updated_at)
VALUES
  ('5eed0000-0000-0000-0000-000000000001', NULL, NULL, 'Version 8.0.0 released', 'Check out the new features and changes.', $sb$- **2v2 matchmaking.** Team matchmaking is finally here! Our matchmaker can now handle matching up
...
- **Observer chat is broken.** Observers are unable to send messages ingame currently. This will be
  fixed in a future update.$sb$, '2021-12-15T12:00:00.000Z', '2021-12-15T12:00:00.000Z'),
  ('5eed0000-0000-0000-0000-000000000002', NULL, NULL, 'Version 8.0.1 released', 'Check out the new features and changes.', $sb$- **Fixed ally chat.** Ally chat should now be working in ranked 2v2 games. And if you never
...
- **Off-center screen starting position.** For some users, generally in positions on the right side
  of the screen, the starting screen position may be slightly off-center from where it usually is
- **Observer chat is broken.** Observers are unable to send messages ingame currently. This will be
  fixed in a future update.$sb$, '2021-12-17T12:00:00.000Z', '2021-12-17T12:00:00.000Z'),
  ('5eed0000-0000-0000-0000-000000000003', NULL, NULL, 'Version 8.2.0 released', 'Check out the new features and changes.', $sb$- **Improved netcode.** We've made a first pass at improving the netcode ingame. With this update,
...
- **Game result submission fixes.** We've fixed a rare bug that prevented some people from
  submitting results at the end of the game.$sb$, '2022-02-05T12:00:00.000Z', '2022-02-05T12:00:00.000Z'),
  ('5eed0000-0000-0000-0000-000000000004', NULL, NULL, 'Version 8.3.0 released', 'Check out the new features and changes.', $sb$- **Main race in ladder rankings.** The ladder rankings now display a player's main race, detected
...
- **Improved shortcut keys.** We've added a shortcut for opening the client settings (Alt + S), as
  ...
  interface that has them (Ctrl + 1-9).$sb$, '2022-05-12T12:00:00.000Z', '2022-05-12T12:00:00.000Z'),
  ('5eed0000-0000-0000-0000-000000000005', NULL, NULL, 'Version 8.4.0 released', 'Check out the new features and changes.', $sb$- **Seasons.** Rankings will now be reset periodically (exact schedule still TBD), with the first
...
- **New ranked system.** We've deployed a new ranked system based on Glicko 2, with tons of
  ...
  We look forward to your continued feedback on this system!$sb$, '2022-06-04T12:00:00.000Z', '2022-06-04T12:00:00.000Z'),
  ('5eed0000-0000-0000-0000-000000000006', NULL, NULL, 'Version 8.4.1 released', 'Check out the new features and changes.', $sb$- **Bug fixes.** We've fixed an issue that prevented the client from running on Windows 7, as well
...
- **Labeled searching.** The matchmaking search status in the navigation area will now display which
  matchmaking type you are queued for.$sb$, '2022-06-13T12:00:00.000Z', '2022-06-13T12:00:00.000Z'),
  ('5eed0000-0000-0000-0000-000000000007', NULL, NULL, 'Version 8.5.0 released', 'Check out the new features and changes.', $sb$- **Ranked divisions.** We've added divisions to all ranked modes based on MMR, along with brand new
...
- **Refreshed Find Match screen.** The Find Match screen now shows information about your current
  ranked division and bonus pool size.$sb$, '2022-06-25T12:00:00.000Z', '2022-06-25T12:00:00.000Z'),
  ('5eed0000-0000-0000-0000-000000000008', NULL, NULL, 'Version 8.6.0 released', 'Check out the new features and changes.', $sb$- **Friends and enemies.** We've built out a new friends list and added a way to block other user's
...
- **And some small stuff:**
  ...
  - Fixed an issue with the Accept Match dialog sometimes staying up permanently if a match had
    failed to start.$sb$, '2022-10-03T12:00:00.000Z', '2022-10-03T12:00:00.000Z'),
  ('5eed0000-0000-0000-0000-000000000009', NULL, NULL, 'Version 8.7.0 released', 'Check out the new features and changes.', $sb$- **Support for WINE.** Although not officially supported, the app is now able to run under WINE on
...
- **New season with tweaks to the rating system.** Alongside this update comes a new season and new
  ...
  - Added an initial period of rapid point gain for wins for each player at the start of the season.
    ...
    accurate matches at the beginning of seasons, etc.).$sb$, '2022-10-27T12:00:00.000Z', '2022-10-27T12:00:00.000Z'),
  ('5eed0000-0000-0000-0000-000000000010', NULL, NULL, 'Version 8.8.0 released', 'Check out the new features and changes.', $sb$- **Unified lobbies**. The Create and Join Lobby actions in the sidebar have been combined into a
...
- **Copy link buttons.** As part of making some of these pages public, we've also made it easier to
  ...
  sending to chat or whispers in the app.$sb$, '2023-03-17T12:00:00.000Z', '2023-03-17T12:00:00.000Z'),
  ('5eed0000-0000-0000-0000-000000000011', NULL, NULL, 'Version 9.0.0 released', 'Check out the new features and changes.', $sb$- **Multi-language support.** We've added an initial version of supporting multiple languages within
...
- **Revamped settings.** We've rebuilt our settings dialog into a full-screen experience to allow
  ...
  this, applicable settings will also be editable on the web version.$sb$, '2023-06-30T12:00:00.000Z', '2023-06-30T12:00:00.000Z'),
  ('5eed0000-0000-0000-0000-000000000012', NULL, NULL, 'Version 9.1.0 released', 'Check out the new features and changes.', $sb$- **Open replay files.** ShieldBattery can now be registered to open replay (.rep) files for faster
...
- **Various bug fixes:**
  ...
  - Fixed Korean language selection not working if it was manually chosen.$sb$, '2023-07-25T12:00:00.000Z', '2023-07-25T12:00:00.000Z'),
  ('5eed0000-0000-0000-0000-000000000013', NULL, NULL, 'Version 9.2.0 released', 'Check out the new features and changes.', $sb$- **Improved ping estimation**. Ping estimation used for game server selection and ingame latency
...
- **Bug fixes.**
  ...
  - Fixed an issue causing race selection to immediately queue for matchmaking.$sb$, '2023-08-10T12:00:00.000Z', '2023-08-10T12:00:00.000Z'),
  ('5eed0000-0000-0000-0000-000000000014', NULL, NULL, 'Version 9.3.0 released', 'Check out the new features and changes.', $sb$- **Replay/Observer UI improvements.** We've added hotkeys for showing/hiding various parts of the
...
- **Bug fixes and small enhancements:**
  ...
  - Made game results submit earlier in the game ending process so that game results can be
    resolved faster.$sb$, '2023-09-05T12:00:00.000Z', '2023-09-05T12:00:00.000Z'),
  ('5eed0000-0000-0000-0000-000000000015', NULL, NULL, 'Version 9.4.0 released', 'Check out the new features and changes.', $sb$- Added a basic match history to user profiles (better filtering capabilities coming soon!)
...
- Various bug fixes$sb$, '2024-01-13T12:00:00.000Z', '2024-01-13T12:00:00.000Z'),
  ('5eed0000-0000-0000-0000-000000000016', NULL, NULL, 'Version 9.5.0 released', 'Check out the new features and changes.', $sb$- Fix a rare issue that made some users unable to download map files and silently fail to launch
  the game
...
- Fixed an issue where some auto-saved replays contained a blank map name$sb$, '2024-06-07T12:00:00.000Z', '2024-06-07T12:00:00.000Z'),
  ('5eed0000-0000-0000-0000-000000000017', NULL, NULL, 'Version 9.5.1 released', 'Check out the new features and changes.', $sb$- Fixed a bug that caused some users to be unable to play games or have slow network routes when
  one of the relay servers responded too slowly$sb$, '2024-06-08T12:00:00.000Z', '2024-06-08T12:00:00.000Z'),
  ('5eed0000-0000-0000-0000-000000000018', NULL, NULL, 'Version 9.6.0 released', 'Check out the new features and changes.', $sb$- **Added a ladder and matchmaking for 1v1 Fastest.** In this mode, users choose which maps they would
...
- **Fixed an issue with unblocking users**$sb$, '2024-10-28T12:00:00.000Z', '2024-10-28T12:00:00.000Z'),
  ('5eed0000-0000-0000-0000-000000000019', NULL, NULL, 'Version 9.7.0 released', 'Check out the new features and changes.', $sb$- **Fixed an issue with users that never played games showing up in the ladder standings**
...
- **Fixed the replay UI rapidly changing size in certain configurations**$sb$, '2024-11-04T12:00:00.000Z', '2024-11-04T12:00:00.000Z'),
  ('5eed0000-0000-0000-0000-000000000020', NULL, NULL, 'Update 10.0.0', 'A big redesign, pre-match drafts, and more!', $sb$This update is one our largest yet, containing over 6 months of work from 6 different
...
— tec27 and the ShieldBattery team$sb$, '2025-07-23T04:00:00.776Z', '2025-07-23T04:00:00.776Z'),
  ('5eed0000-0000-0000-0000-000000000021', NULL, NULL, 'Update 10.1.0', 'Bug fixes, new cursor size features, monitor choice for fullscreen modes, and more!', $sb$Welcome back to another update! This one is a *bit* smaller than the last one, but still
...
top of the home page!$sb$, '2025-08-05T04:59:45.085Z', '2025-08-05T04:59:45.085Z'),
  ('5eed0000-0000-0000-0000-000000000022', NULL, NULL, 'Update 10.2.0', 'The Anti-smurfing smurfing update.', $sb$For this update, we've focused on reducing the amount of smurfing on ShieldBattery. While we
...
of ShieldBattery, please check out the donation links at the top of the home page!$sb$, '2025-08-19T08:12:02.914Z', '2025-08-19T08:12:02.914Z'),
  ('5eed0000-0000-0000-0000-000000000023', NULL, NULL, 'Update 10.4.0', 'Automatic replay uploads, replay viewing from game results, and more!', $sb$This update brings some long-awaited replay features along with a number of bug fixes and
...
- Added crash handler fallback handling to improve stability.$sb$, '2026-03-14T23:09:10.776Z', '2026-03-14T23:09:10.776Z');
