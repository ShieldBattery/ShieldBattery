    ...
    expect(opponentChange).toMatchInlineSnapshot(`
      {
        ...
        "matchmaking": {
          ...
          "matchmakingType": "1v1",
          "outcome": "win",
          "points": 223.98293155291043,
          "pointsChange": 223.98293155291043,
          "pointsConverged": false,
    ...
    expect(playerChange).toMatchInlineSnapshot(`
      {
        ...
        "matchmaking": {
          ...
          "matchmakingType": "1v1",
          "outcome": "win",
          "points": 223.96965173142758,
          "pointsChange": 223.96965173142758,
          "pointsConverged": false,
    ...
    expect(opponentChange).toMatchInlineSnapshot(`
      {
        "leagues": [],
        "matchmaking": {
          "bonusUsed": 0.017068447089571587,
          "bonusUsedChange": 0.017068447089571587,
          "changeDate": 2022-05-02T00:00:00.000Z,
          "gameId": "asdfzxcv",
          "lifetimeGames": 1,
          "matchmakingType": "1v1",
    ...
    expect(playerChange).toMatchInlineSnapshot(`
      {
        "leagues": [],
        "matchmaking": {
          "bonusUsed": 0.030348268572443295,
          "bonusUsedChange": 0.030348268572443295,
          "changeDate": 2022-05-02T00:00:00.000Z,
          "gameId": "asdfzxcv",
          "lifetimeGames": 1,
          "matchmakingType": "1v1",
    ...
    expect(opponentChange).toMatchInlineSnapshot(`
      {
        ...
        "matchmaking": {
          ...
          "matchmakingType": "1v1",
          "outcome": "win",
          "points": 188.9969643094432,
          "pointsChange": 188.9969643094432,
          "pointsConverged": false,
          "probability": 0.17644964001262234,
    ...
    expect(playerChange).toMatchInlineSnapshot(`
      {
        ...
        "matchmaking": {
          ...
          "matchmakingType": "1v1",
          "outcome": "win",
          "points": 177.38116967993585,
          "pointsChange": 177.38116967993585,
          "pointsConverged": false,
    ...
    expect(playerChange).toMatchInlineSnapshot(`
      {
        ...
        "matchmaking": {
          ...
          "matchmakingType": "1v1",
          "outcome": "win",
          "points": 106.13815472407867,
          "pointsChange": 106.13815472407867,
          "pointsConverged": false,
          "probability": 0.5,
    ...
    expect(opponentChange).toMatchInlineSnapshot(`
      {
        ...
        "matchmaking": {
          ...
          "matchmakingType": "1v1",
          "outcome": "win",
          "points": 223.9969643094432,
          "pointsChange": 223.9969643094432,
          "pointsConverged": false,
    ...
    expect(playerChange).toMatchInlineSnapshot(`
      {
        ...
        "matchmaking": {
          ...
          "matchmakingType": "1v1",
          "outcome": "win",
          "points": 6166.3453818031,
          "pointsChange": 176.3453818031001,
          "pointsConverged": true,
          "probability": 0.5,
          "rating": 1504.599790880405,
          "ratingChange": 4.599790880404953,
        ...
        "leagues": [
          {
            ...
            "leagueId": "league-1",
            "outcome": "win",
            "points": 195.98293155291043,
            "pointsChange": 195.98293155291043,
            "pointsConverged": false,
            "userId": 1,
          },
          {
    ...
    expect(player1Change).toMatchInlineSnapshot(`
      {
        ...
        "matchmaking": {
          ...
          "matchmakingType": "2v2",
          "outcome": "win",
          "points": 223.95953419995726,
          "pointsChange": 223.95953419995726,
          "pointsConverged": false,
    ...
    expect(opponent1Change).toMatchInlineSnapshot(`
      {
        ...
        "matchmaking": {
          ...
          "matchmakingType": "2v2",
          "outcome": "win",
          "points": 188.99460182683976,
          "pointsChange": 188.99460182683976,
          "pointsConverged": false,
          "probability": 0.2394965031718012,
    ...
    expect(player2Change).toMatchInlineSnapshot(`
      {
        ...
        "matchmaking": {
          ...
          "matchmakingType": "2v2",
          "outcome": "win",
          "points": 188.98293155291043,
          "pointsChange": 188.98293155291043,
          "pointsConverged": false,
    ...
    expect(opponent1Change).toMatchInlineSnapshot(`
      {
        ...
        "matchmaking": {
          ...
          "matchmakingType": "2v2",
          "outcome": "win",
          "points": 188.98719990117183,
          "pointsChange": 188.98719990117183,
          "pointsConverged": false,
          "probability": 0.4048860337291681,
    ...
    expect(opponent2Change).toMatchInlineSnapshot(`
      {
        ...
        "matchmaking": {
          ...
          "matchmakingType": "2v2",
          "outcome": "win",
          "points": 223.98719990117183,
          "pointsChange": 223.98719990117183,
          "pointsConverged": false,
          "probability": 0.5,
        ...
        "leagues": [
          {
            ...
            "leagueId": "league-1",
            "outcome": "win",
            "points": 5878.021109298073,
            "pointsChange": 128.0211092980728,
            "pointsConverged": true,
            "userId": 3,
          },
          {
            ...
            "leagueId": "league-2",
            "outcome": "win",
            "points": 660.9737183685246,
            "pointsChange": 160.97371836852463,
            "pointsConverged": false,
            "userId": 3,
          },
        ],
