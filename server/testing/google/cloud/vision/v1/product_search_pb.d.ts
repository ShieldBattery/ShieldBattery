...
import * as google_cloud_vision_v1_product_search_service_pb from '../../../../google/cloud/vision/v1/product_search_service_pb.js'
...
export class ProductSearchResults extends jspb.Message {
  ...
  addProductGroupedResults(
    value?: ProductSearchResults.GroupedResult,
    index?: number,
  ...
  static toObject(
    ...
    msg: ProductSearchResults,
  ): ProductSearchResults.AsObject
  static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> }
  static extensionsBinary: { [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message> }
...
export namespace ProductSearchResults {
  ...
  export class GroupedResult extends jspb.Message {
    ...
    addObjectAnnotations(
      value?: ProductSearchResults.ObjectAnnotation,
      index?: number,
