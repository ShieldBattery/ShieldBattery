...
import { LocalSessionSetup } from './local-game'
...
export interface GameSetup {
  /** Private IPC session, generated by the local-game supervisor. */
  localSession?: LocalSessionSetup
...
export interface GameLaunchConfig {
  ...
  /** Isolated BWAPI discovery namespace assigned by the local-game supervisor. */
  bwapiInstance?: string
