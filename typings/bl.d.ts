declare module 'bl' {
  // NOTE(tec27): The @types typings don't properly extend the stream classes and thus can't be
  // used where streams are required :(

  import { Duplex } from 'stream'

  export default class BufferList extends Duplex {
