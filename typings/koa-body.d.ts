...
declare module 'koa-body' {
  interface IKoaBodyFormidableOptions {
    ...
    /**
     * {Integer} Limits the amount of memory all fields together (except files) can allocate in
     * bytes. If this value is exceeded, an 'error' event is emitted, default 2mb (2 * 1024 * 1024)
     */
    ...
    /**
     * {String} If you want checksums calculated for incoming files, set this to either 'sha1' or
     * 'md5', default false
     */
    hash?: string
     ...
     * See https://github.com/felixge/node-formidable#filebegin
     */
  ...
  export default function koaBody(options?: IKoaBodyOptions): Koa.Middleware
}
