...
const cacheKeys: KeyingConfig = {
  ...
  // One-shot payloads carrying the OAuth URL to send the user to. They describe an action about to
  // happen rather than a thing that persists, so there is nothing to identify them by.
  TwitchLinkStart: NON_KEYED_EMBEDDED,
  YoutubeLinkStart: NON_KEYED_EMBEDDED,
