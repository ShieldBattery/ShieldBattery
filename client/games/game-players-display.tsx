...
export function GamePlayersDisplay({
   ...
   * name. Being per-player, this needs no per-column reduction, so it's honest for every game type,
   * including free-for-all splits and columns with mixed outcomes.
   */
