        ...
        {isOwnLobby ? (
          ...
          <>
            ...
            <FullWidthFilledButton
              ...
              // Disabled while any join -- including one targeting a different lobby -- is
              // already in flight.
              disabled={joinRefused || joinPending}
              ...
              <BenchCaption>
                {isInGame
                  ? t(
                      ...
                      "The game is running, so you'll wait on the bench for the next one",
                    )
                  : t(
