...
import isReturningUser from './beta/is-returning-user'
...
import {
  ...
  goToAdminPanel,
  goToSplash
} from './navigation/action-creators'
...
const routes = <Route>
  ...
  <Route component={ConditionalRedirect} conditionFn={(auth) => isReturningUser(auth)}
      actionFn={(props) => goToSplash(routeActions.replace)}>
        ...
        <Route component={ConditionalRedirect} conditionFn={(auth) => isAdmin(auth)}
          ...
          <Route path='/admin'>
            ...
            <Route component={ConditionalRedirect}
              ...
              <Route path='/admin/permissions/:user' component={AdminPermissions} />
            </Route>
            <Route component={ConditionalRedirect}
