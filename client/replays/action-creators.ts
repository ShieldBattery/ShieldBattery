...
import { PlayerInfo } from '../../common/game-launch-config.js'
import { GameType } from '../../common/games/configuration.js'
import { TypedIpcRenderer } from '../../common/ipc.js'
import { SlotType } from '../../common/lobbies/slot.js'
import { SelfUser, makeSbUserId } from '../../common/users/sb-user.js'
import { openDialog, openSimpleDialog } from '../dialogs/action-creators.js'
